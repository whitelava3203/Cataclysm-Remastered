    ...
    public class ScriptDomain : IDisposable
    {
        ...
        public ScriptAssembly CompileAndLoadSource(string cSharpSource, ScriptSecurityMode securityMode = ScriptSecurityMode.UseSettings)
        {
            ...
            lock(this)
            {
                ...
                // Security check
                return RegisterAssembly(compileResult.OutputAssembly, securityMode, securityEngine, true);
            }
        }
        ...
        private ScriptAssembly RegisterAssembly(Assembly assembly, ScriptSecurityMode securityMode, CodeSecurityEngine securityEngine, bool isRuntimeCompiled)
        {
            // Check for error
            if (assembly == null)
                return null;
            ...
            // Create script assembly
            ScriptAssembly scriptAssembly = new ScriptAssembly(this, assembly, securityEngine);
